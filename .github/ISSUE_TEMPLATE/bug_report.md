name: Bug report
description: Report a bug with the Exoole WordPress plugin
labels: ['Type: bug']
...
body:
    - type: markdown
      attributes:
          value: |
              Thank you for taking the time to report a bug in the Exoole plugin! If this is a security issue, please report it privately at https://github.com/theaminuli/exoole/security.
    ...
    - type: textarea
      attributes:
          ...
          description: |
              Provide details about your environment, including WordPress version, Exoole version, and other relevant information.
          placeholder: |
              - WordPress version
              - Exoole version
              - Active theme
    ...
    - type: checkboxes
      ...
      attributes:
          ...
          description: You can search at https://github.com/theaminuli/exoole/issues to ensure the bug has not already been reported.
          options:
              - label: 'Yes'
                required: true
